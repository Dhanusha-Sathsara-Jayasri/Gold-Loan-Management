...
var toIdentifier = __webpack_require__(87)
...
var $EvalError = __webpack_require__(121);
var $RangeError = __webpack_require__(122);
var $ReferenceError = __webpack_require__(123);
var $SyntaxError = __webpack_require__(52);
var $TypeError = __webpack_require__(16);
var $URIError = __webpack_require__(124);
...
var hasProto = __webpack_require__(127)();
...
var hasOwn = __webpack_require__(129);
...
throw new Error("Module parse failed: Unexpected token (815:40)\nYou may need an appropriate loader to handle this file type.\n|      **/\n|     constructor(message, options) {\n|         super(message, { cause: options?.cause });\n|         if (options && typeof options.beforeHandshake === 'boolean') {\n|             this[kBeforeHandshake] = options.beforeHandshake;");
...
throw new Error("Module parse failed: Unexpected token (59:33)\nYou may need an appropriate loader to handle this file type.\n|  */\n| function resolveBSONOptions(options, parent) {\n|     const parentOptions = parent?.bsonOptions;\n|     return {\n|         raw: options?.raw ?? parentOptions?.raw ?? false,");

/***/ }),
/* 30 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (59:52)\nYou may need an appropriate loader to handle this file type.\n|     constructor(bulkResult, isOrdered) {\n|         this.result = bulkResult;\n|         this.insertedCount = this.result.nInserted ?? 0;\n|         this.matchedCount = this.result.nMatched ?? 0;\n|         this.modifiedCount = this.result.nModified ?? 0;");
...
var ms = __webpack_require__(147)
var onFinished = __webpack_require__(23)
...
const list_indexes_cursor_1 = __webpack_require__(194);
...
const upload_1 = __webpack_require__(198);
...
var gssapi_1 = __webpack_require__(204);
...
var common_3 = __webpack_require__(211);
...
var connection_pool_events_1 = __webpack_require__(215);
...
var events_1 = __webpack_require__(216);
...
var server_selection_events_1 = __webpack_require__(217);
...
var mongo_client_auth_providers_1 = __webpack_require__(221);
...
var pathRegexp = __webpack_require__(141);
...
throw new Error("Module parse failed: Unexpected token (68:12)\nYou may need an appropriate loader to handle this file type.\n|                 ? options.readPreference\n|                 : read_preference_1.ReadPreference.primary,\n|             ...(0, bson_1.pluckBSONSerializeOptions)(options)\n|         };\n|         this[kOptions].timeoutMS = options.timeoutMS;");

/***/ }),
/* 69 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (92:29)\nYou may need an appropriate loader to handle this file type.\n|         const srvHostIsCosmosDB = (0, utils_1.isHostMatch)(utils_1.COSMOS_DB_CHECK, this[kOptions].srvHost);\n|         if (documentDBHostnames.length !== 0 || srvHostIsDocumentDB) {\n|             this.mongoLogger?.info('client', utils_1.DOCUMENT_DB_MSG);\n|         }\n|         else if (cosmosDBHostnames.length !== 0 || srvHostIsCosmosDB) {");

/***/ }),
/* 70 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (54:47)\nYou may need an appropriate loader to handle this file type.\n|     for (const wildcard of wildcards) {\n|         if (host === wildcard ||\n|             (wildcard.startsWith('*.') && host?.endsWith(wildcard.substring(2, wildcard.length))) ||\n|             (wildcard.startsWith('*/') && host?.endsWith(wildcard.substring(2, wildcard.length)))) {\n|             return true;");

/***/ }),
/* 71 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (28:54)\nYou may need an appropriate loader to handle this file type.\n|          * @see https://github.com/mongodb/specifications/blob/master/source/read-write-concern/read-write-concern.rst#unknown-levels-and-additional-options-for-string-based-readconcerns\n|          */\n|         this.level = exports.ReadConcernLevel[level] ?? level;\n|     }\n|     /**");

/***/ }),
/* 72 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (39:29)\nYou may need an appropriate loader to handle this file type.\n|         this.mode = mode;\n|         this.tags = tags;\n|         this.hedge = options?.hedge;\n|         this.maxStalenessSeconds = undefined;\n|         this.minWireVersion = undefined;");
...
const ObjectId = __webpack_require__(74).ObjectId;
const objectIdSymbol = __webpack_require__(75).objectIdSymbol;
...
const Decimal = __webpack_require__(223);
const ObjectId = __webpack_require__(73);
const specialProperties = __webpack_require__(224);
const isMongooseObject = __webpack_require__(225);
const getFunctionName = __webpack_require__(226);
const isBsonType = __webpack_require__(227);
const isMongooseArray = __webpack_require__(77).isMongooseArray;
const isObject = __webpack_require__(228);
const isPOJO = __webpack_require__(229);
const symbols = __webpack_require__(75);
const trustedSymbol = __webpack_require__(230).trustedSymbol;
...
const MongooseError = __webpack_require__(0);
...
MongooseError.messages = __webpack_require__(233);
...
MongooseError.DocumentNotFoundError = __webpack_require__(234);
...
MongooseError.CastError = __webpack_require__(235);
...
MongooseError.ValidationError = __webpack_require__(236);
...
MongooseError.ValidatorError = __webpack_require__(238);
...
MongooseError.VersionError = __webpack_require__(239);
...
MongooseError.ParallelSaveError = __webpack_require__(240);
...
MongooseError.OverwriteModelError = __webpack_require__(241);
...
MongooseError.MissingSchemaError = __webpack_require__(242);
...
MongooseError.MongooseServerSelectionError = __webpack_require__(243);
...
MongooseError.DivergentArrayError = __webpack_require__(247);
...
MongooseError.StrictModeError = __webpack_require__(248);
...
MongooseError.StrictPopulateError = __webpack_require__(249);
...
//Server starts here
const express = __webpack_require__(80);
const app = express();
app.listen(3000, () => console.log('Server started on port 3000'));

//Connected to netlify
const serverless = __webpack_require__(163);
const router = express.Router();

// Database connection starts here
const mongoose = __webpack_require__(180);
app.use(express.json());
mongoose.connect('mongodb+srv://admin:admin@cluster0.gzqwq.mongodb.net/Gold-Loan-Management?retryWrites=true&w=majority&appName=Cluster0').then(() => {
...
router.post('/register', (() => {
  var _ref2 = _asyncToGenerator(function* (req, res) {
    ...
    const oldCustomer = yield customers.findOne({
      NIC: NIC
    });
    if (oldCustomer) {
      return res.send({
        status: 'fail',
        data: "Customer Already Registered"
      });
    }
    try {
      ...
      res.send({
        status: "Error While Registering Customer",
        data: error
      });
    }
  });
...
var EventEmitter = __webpack_require__(31).EventEmitter;
var mixin = __webpack_require__(138);
var proto = __webpack_require__(139);
var Route = __webpack_require__(57);
var Router = __webpack_require__(56);
var req = __webpack_require__(151);
var res = __webpack_require__(158);
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(32).concat(__webpack_require__(48)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var getSideChannel = __webpack_require__(119);
...
var GetIntrinsic = __webpack_require__(12);
var callBound = __webpack_require__(130);
var inspect = __webpack_require__(135);
...
var hasSymbolSham = __webpack_require__(126);
...
var callBind = __webpack_require__(131);
...
var bind = __webpack_require__(35);
var GetIntrinsic = __webpack_require__(12);
var setFunctionLength = __webpack_require__(132);
...
var hasDescriptors = __webpack_require__(134)();
...
var utilInspect = __webpack_require__(136);
...
module.exports = __webpack_require__(4).inspect;
...
var finalhandler = __webpack_require__(140);
var Router = __webpack_require__(56);
var methods = __webpack_require__(38);
var middleware = __webpack_require__(142);
...
var Negotiator = __webpack_require__(153)
var mime = __webpack_require__(51)
...
var preferredCharsets = __webpack_require__(154)
var preferredEncodings = __webpack_require__(155)
var preferredLanguages = __webpack_require__(156)
var preferredMediaTypes = __webpack_require__(157)
...
var statuses = __webpack_require__(21)
var merge = __webpack_require__(28);
var sign = __webpack_require__(159).sign;
...
var mime = send.mime;
var resolve = path.resolve;
var vary = __webpack_require__(161);
...
const finish = __webpack_require__(164);
const getFramework = __webpack_require__(165);
const getProvider = __webpack_require__(166);
...
const aws = __webpack_require__(167);
const azure = __webpack_require__(173);
...
const cleanUpEvent = __webpack_require__(168);

const createRequest = __webpack_require__(169);
const formatResponse = __webpack_require__(170);
...
const isBinary = __webpack_require__(171);
const Response = __webpack_require__(41);
const sanitizeHeaders = __webpack_require__(172);
...
const cleanupRequest = __webpack_require__(174);
const createRequest = __webpack_require__(175);
const formatResponse = __webpack_require__(176);
...
const isBinary = __webpack_require__(177);
const Response = __webpack_require__(41);
const sanitizeHeaders = __webpack_require__(178);
...
const setCookieVariations = __webpack_require__(179).variations;
...
const mongoose = __webpack_require__(181);
...
const mongodbDriver = __webpack_require__(182);

__webpack_require__(254).set(mongodbDriver);

const mongoose = __webpack_require__(255);

mongoose.setDriver(mongodbDriver);

mongoose.Mongoose.prototype.mongo = __webpack_require__(42);
...
exports.Collection = __webpack_require__(183);
exports.Connection = __webpack_require__(231);
...
const MongooseCollection = __webpack_require__(184);
const MongooseError = __webpack_require__(0);
const Collection = __webpack_require__(42).Collection;
const ObjectId = __webpack_require__(73);
const getConstructorName = __webpack_require__(18);
const internalToObjectOptions = __webpack_require__(222).internalToObjectOptions;
...
function format(obj, sub, color, shell) {
  ...
  const clone = __webpack_require__(76);
...
const STATES = __webpack_require__(67);
const immediate = __webpack_require__(185);
...
const BSON = __webpack_require__(29);
const error_1 = __webpack_require__(13);
const common_1 = __webpack_require__(30);
/** @public */
...
throw new Error("Module parse failed: Unexpected token (48:25)\nYou may need an appropriate loader to handle this file type.\n|         super();\n|         this.pipeline = pipeline;\n|         this.options = { ...options };\n|         delete this.options.writeConcern;\n|         if (parent instanceof collection_1.Collection) {");

/***/ }),
/* 190 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (72:34)\nYou may need an appropriate loader to handle this file type.\n|             options,\n|             namespace: new utils_1.MongoDBCollectionNamespace(db.databaseName, name),\n|             pkFactory: db.options?.pkFactory ?? utils_1.DEFAULT_PK_FACTORY,\n|             readPreference: read_preference_1.ReadPreference.fromOptions(options),\n|             bsonOptions: (0, bson_1.resolveBSONOptions)(options, db),");

/***/ }),
/* 191 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (33:12)\nYou may need an appropriate loader to handle this file type.\n|         delete clonedOptions.session;\n|         return new AggregationCursor(this.client, this.namespace, this[kPipeline], {\n|             ...clonedOptions\n|         });\n|     }");
...
throw new Error("Module parse failed: Unexpected token (86:27)\nYou may need an appropriate loader to handle this file type.\n|      */\n|     constructor(client, databaseName, options) {\n|         options = options ?? {};\n|         // Filter the options\n|         options = (0, utils_1.filterOptions)(options, DB_OPTIONS_ALLOW_LIST);");
...
throw new Error("Module parse failed: Unexpected token (35:16)\nYou may need an appropriate loader to handle this file type.\n|                 start: 0,\n|                 end: 0,\n|                 ...options\n|             },\n|             readPreference");
...
throw new Error("Module parse failed: Unexpected token (15:29)\nYou may need an appropriate loader to handle this file type.\n|         this.emit(event, ...args);\n|         if (this.component)\n|             this.mongoLogger?.debug(this.component, args[0]);\n|     }\n|     /** @internal */");

/***/ }),
/* 200 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (57:27)\nYou may need an appropriate loader to handle this file type.\n|             throw new error_1.MongoRuntimeError('ClientSession requires a ServerSessionPool');\n|         }\n|         options = options ?? {};\n|         if (options.snapshot === true) {\n|             this[kSnapshotEnabled] = true;");

/***/ }),
/* 201 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (54:51)\nYou may need an appropriate loader to handle this file type.\n|     constructor(client, options) {\n|         this._client = client;\n|         this._proxyOptions = options.proxyOptions ?? {};\n|         this._tlsOptions = options.tlsOptions ?? {};\n|         this._kmsProviders = options.kmsProviders || {};");

/***/ }),
/* 202 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (34:12)\nYou may need an appropriate loader to handle this file type.\n|     get resumeOptions() {\n|         const options = {\n|             ...this.options\n|         };\n|         for (const key of ['resumeAfter', 'startAfter', 'startAtOperationTime']) {");

/***/ }),
/* 203 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (126:28)\nYou may need an appropriate loader to handle this file type.\n|             ? (0, bson_1.serialize)(this._kmsProviders)\n|             : this._kmsProviders;\n|         if (options.options?.logger) {\n|             mongoCryptOptions.logger = options.options.logger;\n|         }");

/***/ }),
/* 204 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (56:58)\nYou may need an appropriate loader to handle this file type.\n|     const { username, password } = credentials;\n|     const mechanismProperties = credentials.mechanismProperties;\n|     const serviceName = mechanismProperties.SERVICE_NAME ?? 'mongodb';\n|     const host = await performGSSAPICanonicalizeHostName(hostAddress.host, mechanismProperties);\n|     const initOptions = {};");
...
throw new Error("Module parse failed: Unexpected token (50:20)\nYou may need an appropriate loader to handle this file type.\n|     switch (options.agreedCompressor) {\n|         case 'snappy': {\n|             Snappy ??= loadSnappy();\n|             return await Snappy.compress(dataToBeCompressed);\n|         }");

/***/ }),
/* 207 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (25:20)\nYou may need an appropriate loader to handle this file type.\n|     }\n|     static fromOptions(options) {\n|         if (options?.explain == null)\n|             return;\n|         const explain = options.explain;");

/***/ }),
/* 208 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (27:32)\nYou may need an appropriate loader to handle this file type.\n|     constructor(collection, query, options) {\n|         super(collection, options);\n|         this.options = options ?? {};\n|         this.cmdBase = {\n|             remove: false,");
...
throw new Error("Module parse failed: Unexpected token (15:32)\nYou may need an appropriate loader to handle this file type.\n|     constructor(parent, options) {\n|         super(options);\n|         this.options = options ?? {};\n|         // NOTE: this was explicitly added for the add/remove user operations, it's likely\n|         //       something we'd want to reconsider. Perhaps those commands can use `Admin`");
...
const timers_1 = __webpack_require__(212);
// shared state names
...
throw new Error("Module parse failed: Unexpected token (58:27)\nYou may need an appropriate loader to handle this file type.\n|         if (options == null)\n|             return undefined;\n|         inherit = inherit ?? {};\n|         let opts;\n|         if (typeof options === 'string' || typeof options === 'number') {");

/***/ }),
/* 214 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (173:22)\nYou may need an appropriate loader to handle this file type.\n|         return (0, utils_1.deepCopy)(command.command);\n|     }\n|     if (command.query?.$query) {\n|         let result;\n|         if (command.ns === 'admin.$cmd') {");

/***/ }),
/* 215 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (106:28)\nYou may need an appropriate loader to handle this file type.\n|         this.reason = reason;\n|         this.serviceId = connection.serviceId;\n|         this.error = error ?? null;\n|     }\n| }");

/***/ }),
/* 216 */
/***/ (function(module, exports) {

throw new Error("Module parse failed: Unexpected token (124:28)\nYou may need an appropriate loader to handle this file type.\n|         this.connectionId = connectionId;\n|         this.duration = duration;\n|         this.reply = reply ?? {};\n|         this.awaited = awaited;\n|     }");
...
const utils_1 = __webpack_require__(70);
const constants_1 = __webpack_require__(218);
/**
...
throw new Error("Module parse failed: Unexpected token (30:48)\nYou may need an appropriate loader to handle this file type.\n|         }\n|         this.srvHost = options.srvHost;\n|         this.srvMaxHosts = options.srvMaxHosts ?? 0;\n|         this.srvServiceName = options.srvServiceName ?? 'mongodb';\n|         this.rescanSrvIntervalMS = 60000;");
...
module.exports = __webpack_require__(74).Decimal128;
...
const MongooseConnection = __webpack_require__(232);
const MongooseError = __webpack_require__(78);
const STATES = __webpack_require__(67);
const mongodb = __webpack_require__(42);
const pkg = __webpack_require__(250);
const processConnectionOptions = __webpack_require__(251);
const setTimeout = __webpack_require__(252).setTimeout;
...
throw new Error("Module parse failed: Unexpected token (895:10)\nYou may need an appropriate loader to handle this file type.\n| \n| function _handleConnectionErrors(err) {\n|   if (err?.name === 'MongoServerSelectionError') {\n|     const originalError = err;\n|     err = new ServerSelectionError();");
...
const getConstructorName = __webpack_require__(18);
const util = __webpack_require__(4);
const combinePathErrors = __webpack_require__(237);
...
const MongooseError = __webpack_require__(0);
const allServersUnknown = __webpack_require__(244);
const isAtlas = __webpack_require__(245);
const isSSLError = __webpack_require__(246);
